...
function keyname(val, keys) {
    console.log(keys);
}
let decor = (() => {
    let _classDecorators = [classname];
    ...
    var decor = class {
        ...
        static {
            ...
            decor = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        val1 = __runInitializers(this, _val1_initializers, void 0);
        val2 = __runInitializers(this, _val1_extraInitializers);
        constructor(val1, val2) {
            this.val1 = val1;
            this.val2 = val2;
        }
    };
    return decor = _classThis;
})();
